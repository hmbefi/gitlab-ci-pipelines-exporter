...
| `gitlab_ci_pipeline_failed_jobs_count` | Number of failed jobs | [project], [topics], [ref], [runner_description], [kind], [source], [variables], [stage], [job_name], [tag_list], [commit] | `project_defaults.pull.pipeline.jobs.enabled` |
